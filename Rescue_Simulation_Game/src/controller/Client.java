...
public class Client extends JFrame implements Runnable {
	...
	public void showMessage(String text) {
		// this is because updating GUI need to be in only one thread because
		// asynchronous threads may results in unexpected GUI
		// so invokeLater takes runnable object (for threads) and EventDispatcher thread
		// will handle the updates on thr GUI
//
