...
public class M1PublicTests {
	...
	public void testReadingCitizenFromCSV() throws Exception {
		try {
			...
			Method method = Class.forName(simulatorPath).getDeclaredMethod("loadBuildings",
	...
	@Test(timeout = 1000)
	public void testConstructorCommandCenterConstructor2Initialization() throws Exception {
		Object commandCenter2 = Class.forName(commandCenterPath).getConstructor().newInstance();
		String[] names = { "visibleBuildings", "visibleCitizens", "emergencyUnits" };
		Object[] values = { new ArrayList<>(), new ArrayList<>(), new ArrayList<>() };
		testConstructorInitialization(commandCenter2, names, values);

		final Field f = Class.forName(commandCenterPath).getDeclaredField("engine");
		f.setAccessible(true);

		Object engine = f.get(commandCenter2);

		assertFalse("CommandCenter \"engine\" should not be null", engine == null);
	}
	...
	public void testInstanceVariableResidentialBuildingStructuralIntegrityGetterAndSetter() throws Exception {
		testGetterMethodExistsInClass(Class.forName(residentialBuildingPath), "getStructuralIntegrity", int.class,
				true);
		testSetterMethodExistsInClass(Class.forName(residentialBuildingPath), "setStructuralIntegrity", int.class,
				true);
	}
	...
	public void testInstanceVariableCitizenStateGetterLogic1() throws Exception {
		...
		Object citizen1 = Class.forName(citizenPath)
				...
				.newInstance(address0, String7, String0, int1);
	...
	public void testInstanceVariableCitizenStateGetterLogic2() throws Exception {
		...
		String String3 = "r";
		int int3 = 3;
		Object citizen2 = Class.forName(citizenPath)
				.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
				.newInstance(address2, String4, String3, int3);
	...
	public void testInstanceVariableResidentialBuildingLocationGetterLogic1() throws Exception {
		...
		int int9 = 9;
		Object address2 = Class.forName(addressPath).getConstructor(int.class, int.class).newInstance(int8, int9);
		Object residentialBuilding1 = Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
				.newInstance(address2);
	...
	public void testInstanceVariableEvacuatorMaxCapacityGetterLogic1() throws Exception {
		...
		int int4 = 4;
		int int1 = 1;
		Object evacuator1 = Class.forName(evacuatorPath)
				.getConstructor(String.class, Class.forName(addressPath), int.class, int.class)
				.newInstance(String5, address0, int4, int1);
	...
	public void testInstanceVariableEvacuatorMaxCapacityGetterLogic2() throws Exception {
		...
		Object address1 = Class.forName(addressPath).getConstructor(int.class, int.class).newInstance(int0, int9);
		int int4 = 4;
		Object evacuator2 = Class.forName(evacuatorPath)
				.getConstructor(String.class, Class.forName(addressPath), int.class, int.class)
				.newInstance(String0, address1, int9, int4);
	...
	public void testInstanceVariableFireTruckUnitIDGetterLogic1() throws Exception {
		...
		Object address1 = Class.forName(addressPath).getConstructor(int.class, int.class).newInstance(int0, int9);
		int int2 = 2;
		Object fireTruck1 = Class.forName(fireTruckPath)
				.getConstructor(String.class, Class.forName(addressPath), int.class)
				.newInstance(String1, address1, int2);
	...
	public void testInstanceVariableFireTruckUnitIDGetterLogic2() throws Exception {
		...
		Object address0 = Class.forName(addressPath).getConstructor(int.class, int.class).newInstance(int8, int5);
		int int9 = 9;
		Object fireTruck2 = Class.forName(fireTruckPath)
				.getConstructor(String.class, Class.forName(addressPath), int.class)
				.newInstance(String5, address0, int9);
	...
	public void testInstanceVariableGasControlUnitUnitIDGetterLogic1() throws Exception {
		...
		Object address2 = Class.forName(addressPath).getConstructor(int.class, int.class).newInstance(int8, int9);
		int int3 = 3;
		Object gasControlUnit1 = Class.forName(gasControlUnitPath)
				.getConstructor(String.class, Class.forName(addressPath), int.class)
				.newInstance(String7, address2, int3);
	...
	public void testInstanceVariableGasControlUnitUnitIDGetterLogic2() throws Exception {
		...
		Object address2 = Class.forName(addressPath).getConstructor(int.class, int.class).newInstance(int8, int9);
		int int0 = 0;
		Object gasControlUnit2 = Class.forName(gasControlUnitPath)
				.getConstructor(String.class, Class.forName(addressPath), int.class)
	...
	public void testInstanceVariableAmbulanceUnitIDGetterLogic1() throws Exception {
		...
		Object address2 = Class.forName(addressPath).getConstructor(int.class, int.class).newInstance(int8, int9);
		int int7 = 7;
		Object ambulance1 = Class.forName(ambulancePath)
				.getConstructor(String.class, Class.forName(addressPath), int.class)
				.newInstance(String8, address2, int7);
	...
	public void testInstanceVariableAmbulanceUnitIDGetterLogic2() throws Exception {
		...
		int int9 = 9;
		Object address2 = Class.forName(addressPath).getConstructor(int.class, int.class).newInstance(int8, int9);
		Object ambulance2 = Class.forName(ambulancePath)
				.getConstructor(String.class, Class.forName(addressPath), int.class)
				.newInstance(String0, address2, int9);
	...
	public void testInstanceVariableDiseaseControlUnitUnitIDGetterLogic1() throws Exception {
		...
		Object address0 = Class.forName(addressPath).getConstructor(int.class, int.class).newInstance(int8, int5);
		int int6 = 6;
		Object diseaseControlUnit1 = Class.forName(diseaseControlUnitPath)
				.getConstructor(String.class, Class.forName(addressPath), int.class)
				.newInstance(String4, address0, int6);
	...
	public void testInstanceVariableDiseaseControlUnitUnitIDGetterLogic2() throws Exception {
		...
		Object address1 = Class.forName(addressPath).getConstructor(int.class, int.class).newInstance(int0, int9);
		int int3 = 3;
		Object diseaseControlUnit2 = Class.forName(diseaseControlUnitPath)
				.getConstructor(String.class, Class.forName(addressPath), int.class)
				.newInstance(String2, address1, int3);
	...
	public void testInstanceVariableCollapseStartCycleGetterLogic1() throws Exception {
		...
		Object residentialBuilding2 = Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
				.newInstance(address0);
		Object collapse1 = Class.forName(collapsePath).getConstructor(int.class, Class.forName(residentialBuildingPath))
				.newInstance(int2, residentialBuilding2);
	...
	public void testInstanceVariableCollapseStartCycleGetterLogic2() throws Exception {
		...
		Object residentialBuilding2 = Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
				.newInstance(address0);
		Object collapse2 = Class.forName(collapsePath).getConstructor(int.class, Class.forName(residentialBuildingPath))
				.newInstance(int0, residentialBuilding2);
	...
	public void testInstanceVariableFireStartCycleGetterLogic1() throws Exception {
		...
		Object residentialBuilding1 = Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
				.newInstance(address2);
		Object fire1 = Class.forName(firePath).getConstructor(int.class, Class.forName(residentialBuildingPath))
				.newInstance(int6, residentialBuilding1);
	...
	public void testInstanceVariableFireStartCycleGetterLogic2() throws Exception {
		...
		Object residentialBuilding1 = Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
				.newInstance(address2);
		Object fire2 = Class.forName(firePath).getConstructor(int.class, Class.forName(residentialBuildingPath))
				.newInstance(int2, residentialBuilding1);
	...
	public void testInstanceVariableGasLeakStartCycleGetterLogic1() throws Exception {
		...
		Object residentialBuilding2 = Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
				.newInstance(address0);
		Object gasLeak1 = Class.forName(gasLeakPath).getConstructor(int.class, Class.forName(residentialBuildingPath))
				.newInstance(int7, residentialBuilding2);
	...
	public void testInstanceVariableGasLeakStartCycleGetterLogic2() throws Exception {
		...
		Object residentialBuilding0 = Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
				.newInstance(address0);
		Object gasLeak2 = Class.forName(gasLeakPath).getConstructor(int.class, Class.forName(residentialBuildingPath))
				.newInstance(int6, residentialBuilding0);
	...
	public void testInstanceVariableInfectionStartCycleGetterLogic1() throws Exception {
		...
		Object citizen2 = Class.forName(citizenPath)
				.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
				.newInstance(address2, String4, String3, int3);
		Object infection1 = Class.forName(infectionPath).getConstructor(int.class, Class.forName(citizenPath))
				.newInstance(int6, citizen2);
	...
	public void testInstanceVariableInfectionStartCycleGetterLogic2() throws Exception {
		...
		Object infection2 = Class.forName(infectionPath).getConstructor(int.class, Class.forName(citizenPath))
				.newInstance(int9, citizen0);
	...
	public void testInstanceVariableInjuryStartCycleGetterLogic1() throws Exception {
		...
		Object citizen1 = Class.forName(citizenPath)
				.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
				.newInstance(address0, String7, String0, int1);
		Object injury1 = Class.forName(injuryPath).getConstructor(int.class, Class.forName(citizenPath))
				.newInstance(int5, citizen1);
	...
	public void testInstanceVariableInjuryStartCycleGetterLogic2() throws Exception {
		...
		Object citizen0 = Class.forName(citizenPath)
				.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
				.newInstance(address1, String7, String7, int9);
		Object injury2 = Class.forName(injuryPath).getConstructor(int.class, Class.forName(citizenPath))
				.newInstance(int1, citizen0);
	...
	public void testConstructorCitizenConstructor1Initialization() throws Exception {
		...
		Object[] values = { Enum.valueOf((Class<Enum>) Class.forName(citizenStatePath), "SAFE"), String0, String7, 1,
				100, 0, 0, address0 };
	...
	public void testConstructorCitizenConstructor2Initialization() throws Exception {
		...
		Object citizen2 = Class.forName(citizenPath)
				...
				.newInstance(address2, String4, String3, int3);
		String[] names = { "state", "name", "nationalID", "age", "hp", "bloodLoss", "toxicity", "location" };
		Object[] values = { Enum.valueOf((Class<Enum>) Class.forName(citizenStatePath), "SAFE"), String3, String4, 3,
				100, 0, 0, address2 };
	...
	public void testConstructorEvacuatorConstructor1Initialization() throws Exception {
		...
		Object[] values = { new ArrayList<>(), 1, 0, String5,
				Enum.valueOf((Class<Enum>) Class.forName(unitStatePath), "IDLE"), address0, 0, 4 };
	...
	public void testConstructorEvacuatorConstructor2Initialization() throws Exception {
		...
		String[] names = { "passengers", "maxCapacity", "distanceToBase", "unitID", "state", "location",
				"distanceToTarget", "stepsPerCycle" };
		Object[] values = { new ArrayList<>(), 4, 0, String0,
				Enum.valueOf((Class<Enum>) Class.forName(unitStatePath), "IDLE"), address1, 0, 9 };
	...
	public void testConstructorAmbulanceConstructor1Initialization() throws Exception {
		...
		String[] names = { "healingAmount", "treatmentAmount", "unitID", "state", "location", "distanceToTarget",
				"stepsPerCycle" };
		Object[] values = { 10, 10, String8, Enum.valueOf((Class<Enum>) Class.forName(unitStatePath), "IDLE"), address2,
				0, 7 };
	...
	public void testConstructorAmbulanceConstructor2Initialization() throws Exception {
		...
		String[] names = { "healingAmount", "treatmentAmount", "unitID", "state", "location", "distanceToTarget",
				"stepsPerCycle" };
		Object[] values = { 10, 10, String0, Enum.valueOf((Class<Enum>) Class.forName(unitStatePath), "IDLE"), address2,
				0, 9 };
	...
	public void testConstructorDiseaseControlUnitConstructor1Initialization() throws Exception {
		...
		String[] names = { "healingAmount", "treatmentAmount", "unitID", "state", "location", "distanceToTarget",
				"stepsPerCycle" };
		Object[] values = { 10, 10, String4, Enum.valueOf((Class<Enum>) Class.forName(unitStatePath), "IDLE"), address0,
				0, 6 };
	...
	public void testConstructorDiseaseControlUnitConstructor2Initialization() throws Exception {
		...
		String[] names = { "healingAmount", "treatmentAmount", "unitID", "state", "location", "distanceToTarget",
				"stepsPerCycle" };
		Object[] values = { 10, 10, String2, Enum.valueOf((Class<Enum>) Class.forName(unitStatePath), "IDLE"), address1,
				0, 3 };
	...
	@Test(timeout = 1000)
	public void testInstanceVariableSimulatorWorldInitialization() throws Exception {
		try {
			copyFiles();

			Object simulator = Class.forName(simulatorPath).getConstructor().newInstance();

			String[] names = { "currentCycle", "buildings", "citizens", "emergencyUnits", "plannedDisasters",
					"executedDisasters" };
			...
			try {
				...
				fail(curr.getSimpleName() + " class should initialize the instance variable world");
			}
			f.setAccessible(true);
			...
			if (world.length == 10) {
				if (world[0].length <= 0 || world[0].length > 10)
					fail(simulator.getClass().getSimpleName()
							+ " class should initialize the instance variable \"world\" with size 10x10");
			} else
				fail(simulator.getClass().getSimpleName()
						+ " class should initialize the instance variable \"world\" with size 10x10");
			...
			for (int i = 0; i < world.length; i++) {
				for (int j = 0; j < world[i].length; j++) {
					...
					try {
						...
						fail(cx.getSimpleName() + " class should initialize the instance variable x");
					}
					...
					try {
						...
						fail(cy.getSimpleName() + " class should initialize the instance variable y");
					}
					...
					if (fx != i || fy != j) {
						fail(curr.getSimpleName()
								+ " class should initialize the instance variable world correctly expected (" + i + ", "
								+ j + ") but was (" + j + ", " + i + ").");
					}
				}
			}
	...
	private void testConstructorInitializationNotNull(Object createdObject, String[] names)
		...
		for (int i = 0; i < names.length; i++) {
			...
			if (f.get(createdObject) == null)
				fail("The constructor of the " + createdObject.getClass().getSimpleName()
	...
	public void testReadingBuildingsFromCSV() throws Exception {
		try {
			...
			((ArrayList<Object>) f1.get(s)).add(Class.forName(citizenPath)
					.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
					.newInstance(testWorld[5][5], "1", "zizo", 25));
			((ArrayList<Object>) f1.get(s)).add(Class.forName(citizenPath)
					.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
					.newInstance(testWorld[6][6], "2", "amr", 30));
			((ArrayList<Object>) f1.get(s)).add(Class.forName(citizenPath)
					.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
					.newInstance(testWorld[3][3], "3", "karam", 40));
			((ArrayList<Object>) f1.get(s)).add(Class.forName(citizenPath)
					.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
					.newInstance(testWorld[5][5], "4", "maisarah", 45));
			((ArrayList<Object>) f1.get(s)).add(Class.forName(citizenPath)
					.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
					.newInstance(testWorld[5][5], "5", "mostafa", 20));
			Method method = Class.forName(simulatorPath).getDeclaredMethod("loadBuildings",
					new Class[] { String.class });
			method.setAccessible(true);
			...
			correctBuildings.add(Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
					.newInstance(testWorld[9][9]));
			correctBuildings.add(Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
					.newInstance(testWorld[5][5]));
			correctBuildings.add(Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
					.newInstance(testWorld[6][6]));
			correctBuildings.add(Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
					.newInstance(testWorld[3][3]));
			correctBuildings.add(Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
					.newInstance(testWorld[5][6]));
			correctBuildings.add(Class.forName(residentialBuildingPath).getConstructor(Class.forName(addressPath))
					.newInstance(testWorld[9][3]));
			...
			for (int i = 0; i < testBuildings.size(); i++) {
				...
				assertEquals("Building  Location  is not loaded correctly from the CSV file",
						(correctBuildings.get(i)).getClass().getDeclaredMethod("getLocation")
								.invoke(correctBuildings.get(i)),
						(testBuildings.get(i)).getClass().getDeclaredMethod("getLocation")
								.invoke(testBuildings.get(i)));
			}
		} catch (Exception e) {
	...
	public void testReadingCitizenFromCSV2() throws Exception {
		try {
			...
			Object[][] testWorld = (Object[][]) f2.get(s);
			((ArrayList<Object>) f1.get(s)).clear();
			((ArrayList<Object>) f1.get(s)).add(Class.forName(residentialBuildingPath)
					.getConstructor(Class.forName(addressPath)).newInstance(testWorld[9][9]));
			((ArrayList<Object>) f1.get(s)).add(Class.forName(residentialBuildingPath)
					.getConstructor(Class.forName(addressPath)).newInstance(testWorld[5][5]));
			((ArrayList<Object>) f1.get(s)).add(Class.forName(residentialBuildingPath)
					.getConstructor(Class.forName(addressPath)).newInstance(testWorld[6][6]));
			((ArrayList<Object>) f1.get(s)).add(Class.forName(residentialBuildingPath)
					.getConstructor(Class.forName(addressPath)).newInstance(testWorld[3][3]));
			((ArrayList<Object>) f1.get(s)).add(Class.forName(residentialBuildingPath)
					.getConstructor(Class.forName(addressPath)).newInstance(testWorld[5][6]));
			((ArrayList<Object>) f1.get(s)).add(Class.forName(residentialBuildingPath)
					.getConstructor(Class.forName(addressPath)).newInstance(testWorld[9][3]));

			Method method = Class.forName(simulatorPath).getDeclaredMethod("loadCitizens",
					new Class[] { String.class });
			method.setAccessible(true);
			...
			correctCitizens.add(Class.forName(citizenPath)
					.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
					.newInstance(testWorld[5][5], "1", "zizo", 25));
			correctCitizens.add(Class.forName(citizenPath)
					.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
			...
			for (int i = 0; i < correctCitizens.size(); i++) {
				...
				assertEquals("Citzen  Location is not loaded correctly from the CSV file",
						(correctCitizens.get(i)).getClass().getDeclaredMethod("getLocation")
								.invoke(correctCitizens.get(i)),
						(testCitizens.get(i)).getClass().getDeclaredMethod("getLocation").invoke(testCitizens.get(i)));

				assertEquals("Citzen  NationalID is not loaded correctly from the CSV file",
						(correctCitizens.get(i)).getClass().getDeclaredMethod("getNationalID")
								.invoke(correctCitizens.get(i)),
						(testCitizens.get(i)).getClass().getDeclaredMethod("getNationalID")
								.invoke(testCitizens.get(i)));

				assertEquals("Citzen Name is not loaded correctly from the CSV file",
				...
				assertEquals("Citzen Age is not loaded correctly from the CSV file",
	...
	public void testReadingDisastersFromCSV() throws Exception {
		try {
			...
			((ArrayList<Object>) f1.get(s)).add(Class.forName(citizenPath)
					.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
					.newInstance(testWorld[3][3], "7", "karam", 40));
			((ArrayList<Object>) f1.get(s)).add(Class.forName(citizenPath)
					.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
					.newInstance(testWorld[5][5], "3", "maisarah", 45));
			((ArrayList<Object>) f1.get(s)).add(Class.forName(citizenPath)
					.getConstructor(Class.forName(addressPath), String.class, String.class, int.class)
					.newInstance(testWorld[5][5], "5", "mostafa", 20));

			((ArrayList<Object>) f2.get(s)).clear();
			((ArrayList<Object>) f2.get(s)).add(Class.forName(residentialBuildingPath)
					.getConstructor(Class.forName(addressPath)).newInstance(testWorld[9][9]));
			((ArrayList<Object>) f2.get(s)).add(Class.forName(residentialBuildingPath)
					.getConstructor(Class.forName(addressPath)).newInstance(testWorld[5][5]));
			((ArrayList<Object>) f2.get(s)).add(Class.forName(residentialBuildingPath)
			...
			Method method = Class.forName(simulatorPath).getDeclaredMethod("loadDisasters",
					new Class[] { String.class });
			method.setAccessible(true);
			...
			correctDisasters.add(Class.forName(injuryPath).getConstructor(int.class, Class.forName(citizenPath))
					.newInstance(1, correctCitizens.get(1)));
			correctDisasters.add(Class.forName(infectionPath).getConstructor(int.class, Class.forName(citizenPath))
					.newInstance(2, correctCitizens.get(0)));
			correctDisasters
					.add(Class.forName(firePath).getConstructor(int.class, Class.forName(residentialBuildingPath))
							.newInstance(4, correctBuildings.get(0)));
			correctDisasters
					.add(Class.forName(gasLeakPath).getConstructor(int.class, Class.forName(residentialBuildingPath))
							.newInstance(5, correctBuildings.get(1)));
			...
			for (int i = 0; i < correctDisasters.size(); i++) {
				assertFalse("Disaster Target should not be null",
						testDisasters.get(i).getClass().getMethod("getTarget").invoke(testDisasters.get(i)) == null);
				assertFalse(
						"Disaster creation type should be done correctly, expected \""
				...
				assertEquals("Disaster Start Cycle is not loaded correctly from the CSV file",
				...
				if (Class.forName(citizenPath).isInstance(
						correctDisasters.get(i).getClass().getMethod("getTarget").invoke(correctDisasters.get(i)))
						&& Class.forName(citizenPath).isInstance(
								testDisasters.get(i).getClass().getMethod("getTarget").invoke(testDisasters.get(i)))) {
					Object correctDisasterTarget = (correctDisasters.get(i).getClass().getMethod("getTarget")
							.invoke(correctDisasters.get(i)));
					Object testDisasterTarget = (testDisasters.get(i).getClass().getMethod("getTarget")
							.invoke(testDisasters.get(i)));
					assertEquals("Disaster Target Name is not loaded correctly from the CSV file",
					...
					assertEquals("Disaster Target NationalID is not loaded correctly from the CSV file",
					...
					assertEquals("Disaster Target Age is not loaded correctly from the CSV file",
					...
					assertEquals("Disaster Target Location is not loaded correctly from the CSV file",
				...
				if (Class.forName(residentialBuildingPath).isInstance(
						correctDisasters.get(i).getClass().getMethod("getTarget").invoke(correctDisasters.get(i)))
						&& Class.forName(residentialBuildingPath).isInstance(
								testDisasters.get(i).getClass().getMethod("getTarget").invoke(testDisasters.get(i)))) {
	...
	public void testReadingUnitsFromCSV() throws Exception {
		try {
			...
			correctUnit.add(
					Class.forName(ambulancePath).getConstructor(String.class, Class.forName(addressPath), int.class)
							.newInstance("1", testWorld[0][0], 2));
			correctUnit.add(Class.forName(diseaseControlUnitPath)
					.getConstructor(String.class, Class.forName(addressPath), int.class)
					.newInstance("2", testWorld[0][0], 4));
			correctUnit.add(Class.forName(evacuatorPath)
					.getConstructor(String.class, Class.forName(addressPath), int.class, int.class)
					.newInstance("3", testWorld[0][0], 6, 8));
			correctUnit.add(
					Class.forName(fireTruckPath).getConstructor(String.class, Class.forName(addressPath), int.class)
							.newInstance("4", testWorld[0][0], 8));
			correctUnit.add(Class.forName(gasControlUnitPath)
					.getConstructor(String.class, Class.forName(addressPath), int.class)
					.newInstance("9", testWorld[0][0], 3));
			...
			for (int i = 0; i < correctUnit.size(); i++) {
				...
				assertFalse(
						"Unit creation type should be done correctly, expected \""
				...
				assertEquals("unit Location is not loaded correctly from the CSV file",
				...
				assertEquals("unit Steps is not loaded correctly from the CSV file",
				...
				assertEquals("unit id is not loaded correctly from the CSV file",
	...
	public void testReadingCSVCallingLoads() throws Exception {
		...
		try {
			...
			final Field citizenField = Class.forName(simulatorPath).getDeclaredField("citizens");

			citizenField.setAccessible(true);

			final Field buildingsField = Class.forName(simulatorPath).getDeclaredField("buildings");
			...
			method = Class.forName(simulatorPath).getDeclaredMethod("loadCitizens", new Class[] { String.class });
			method.setAccessible(true);
			ArrayList<Object> testCitizens = new ArrayList<Object>();
			...
			for (int i = 0; i < testBuildings.size(); i++) {
				...
				ArrayList<Object> currentOccupants = (ArrayList<Object>) Class.forName(residentialBuildingPath)
						.getMethod("getOccupants").invoke(currentBuilding);
				if (i == 0)
					assertEquals("The number of citizens per building is not correct.", 5, currentOccupants.size());
			...
			correctDisasters
					.add(Class.forName(firePath).getConstructor(int.class, Class.forName(residentialBuildingPath))
							.newInstance(4, correctBuildingsForDisasters.get(0)));
			correctDisasters
					.add(Class.forName(gasLeakPath).getConstructor(int.class, Class.forName(residentialBuildingPath))
							.newInstance(5, correctBuildingsForDisasters.get(1)));
